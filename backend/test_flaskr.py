...
from models import setup_db, Question, Category, database_password, database_user
...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = f'postgresql://{database_user}:{database_password}@localhost:5432/{self.database_name}'
